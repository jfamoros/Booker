...
namespace PartyBot.Services
{
    public sealed class LavaLinkAudio
    {
        ...
        public LavaLinkAudio(LavaNode lavaNode, DiscordSocketClient client)
        {
            _lavaNode = lavaNode;
            _client = client;
        }
        ...
        public async Task TrackEnded(TrackEndedEventArgs args)
        {
            ...
            {
                MusicTimer = new Timer(TimeSpan.FromMinutes(5).TotalMilliseconds);
                MusicTimer.Elapsed += (source, e) => OnTimedEvent(source, e, args);
                MusicTimer.AutoReset = false;
        ...
        private async void OnTimedEvent(Object source, ElapsedEventArgs e, TrackEndedEventArgs args)
        {
